...
myWindow.AppFactory = new __WEBPACK_IMPORTED_MODULE_0__appFactory__["a" /* AppFactory */]();
myWindow.$ = __WEBPACK_IMPORTED_MODULE_1_jquery__;
myWindow.jQuery = __WEBPACK_IMPORTED_MODULE_1_jquery__;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__apiClient__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__auth_LoginManager__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers_errorHelper__ = __webpack_require__(8);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ApiClient;
...
class LoginManager {
    constructor(apiClient, errorHelper, storageHelper) {
        ...
        this._storageHelper = storageHelper;
        this._overlayLoader = new __WEBPACK_IMPORTED_MODULE_1__ui_overlayLoader__["a" /* OverlayLoader */]('#frmLogin');
        ...
        this._$form.on('submit', (evt) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this._apiClient.post('login', loginRequest).then((response) => {
                    ...
                    const loginResponse = __WEBPACK_IMPORTED_MODULE_0__valueObjects_loginResponse__["a" /* LoginResponse */].fromResponse(response);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = LoginManager;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__usrType__ = __webpack_require__(7);

class LoginResponse {
    constructor(tokenCode, ipAddress, userAgent, prefix, expiresAt, usrId, usrType) {
    ...
    static fromResponse(response) {
        return new LoginResponse(response.tokenCode, response.ipAddress, response.userAgent, response.prefix, response.expiresAt, response.usrId, response.usrType == __WEBPACK_IMPORTED_MODULE_0__usrType__["a" /* UsrType */].ADMIN ? __WEBPACK_IMPORTED_MODULE_0__usrType__["a" /* UsrType */].ADMIN : __WEBPACK_IMPORTED_MODULE_0__usrType__["a" /* UsrType */].GENERAL);
    }
    get tokenCode() {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = LoginResponse;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UsrType; });
var UsrType;
(function (UsrType) {
    UsrType[UsrType["ADMIN"] = 0] = "ADMIN";
    UsrType[UsrType["GENERAL"] = 1] = "GENERAL";
})(UsrType || (UsrType = {}));
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ErrorHelper;
...
class StorageHelper {
    ...
    getCookie(key) {
        const result = __WEBPACK_IMPORTED_MODULE_0_js_cookie__["get"](key);
...
class RegisterManager {
    constructor(apiClient, errorHelper, storageHelper) {
        ...
        this._errorHelper = errorHelper;
        this._storageHelper = storageHelper;
        this._overlayLoader = new __WEBPACK_IMPORTED_MODULE_0__ui_overlayLoader__["a" /* OverlayLoader */]('#frmRegister');
        this._$messages = $('div.messages');
...
/* harmony export (immutable) */ __webpack_exports__["a"] = RegisterManager;
...
class PasswordResetManager {
    constructor(apiClient, errorHelper, storageHelper) {
        ...
        this._errorHelper = errorHelper;
        this._storageHelper = storageHelper;
        this._overlayLoader = new __WEBPACK_IMPORTED_MODULE_0__ui_overlayLoader__["a" /* OverlayLoader */]('#frmPasswordReset');
        this._$messages = $('div.messages');
    ...
    onFormSubmit() {
        ...
        this._$formPin.on('submit', (evt) => __awaiter(this, void 0, void 0, function* () {
            evt.preventDefault();
...
class ProfileManager {
    ...
    onChangePasswordFormSubmit() {
        this._$formChangePassword.on('submit', (evt) => __awaiter(this, void 0, void 0, function* () {
            evt.preventDefault();
    ...
    onChangeEmailFormSubmit() {
        this._$formChangeEmail.on('submit', (evt) => __awaiter(this, void 0, void 0, function* () {
            evt.preventDefault();
            this.hideMessage();
            this._overlayLoader.render();
            try {
                ...
                this._apiClient.post('change_email', request).then((response) => {
                    ...
                    const newEmail = this._$newEmailAddress.val();
